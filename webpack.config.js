...
module.exports={
    ...
    // import할 때 확장자를 명시하지 않아도 알아서 찾을 수 있게 하는 코드
    resolve:{
      extensions: ['.js','.vue'],
      alias: {
        ...
        rules: [
            ...
            },
            {
                ...
                use:[                               // npm으로 받았던 것들 (순서중요, 아래쪽이 더 먼저해석됨)
                    'vue-style-loader',             // // .vue 확장자 내부 style 태그 부분을 해석해서 동작할 수 있게 해주는 loader
            ...
            {
                test: /\.(png|jpe?g|gif|webp)$/,    // 해당 확장자의 파일을 읽어서 file-loader를 적용
                use: [
                    'file-loader'
                ]
            }
